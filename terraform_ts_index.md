...
If you run into an issue with the IBM Cloud Provider plug-in for Terraform provider plug-in or want to ask questions about how to configure {{site.data.keyword.cloud_notm}} resources, choose one of the following support channels:  

## For instance
{: #for-instance}

- **GitHub**: The IBM Cloud Provider plug-in for Terraform provider plug-in is managed as an open-source project where you can submit [issues](https://github.com/IBM-Cloud/terraform-provider-ibm/issues){: external} for the development team. 
...
- **IBM Support**: If you run into an issue with the IBM Cloud Provider plug-in for Terraform provider plug-in by using {{site.data.keyword.bplong_notm}}, you can also contact IBM Support by [Opening a support case](/docs/get-support?topic=get-support-using-avatar).
