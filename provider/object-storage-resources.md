...
| `cross_region_location` | String | Optional | The location for a cross-regional bucket. Supported values are `us`, `eu`, and `ap`. If you use this parameter, do not set `single_site_location` or `region_location` at the same time. |
