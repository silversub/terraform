...
To find an example for configuring a virtual server instance that connects to a postgre database, see [here](https://github.com/IBM-Cloud/terraform-provider-ibm/tree/master/examples/ibm-database).
